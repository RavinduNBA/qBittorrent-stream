...
namespace BitTorrent
{
    ...
    public:
        ...
        virtual int peerConnectTimeout() const = 0;
        virtual void setPeerConnectTimeout(int value) = 0;
        ...
        virtual int handshakeTimeout() const = 0;
        virtual void setHandshakeTimeout(int value) = 0;
        virtual int maxPeerlistSize() const = 0;
        virtual void setMaxPeerlistSize(int value) = 0;
        virtual int maxWebSeedConnections() const = 0;
        virtual void setMaxWebSeedConnections(int value) = 0;
        virtual int trackerCompletionTimeout() const = 0;
        virtual void setTrackerCompletionTimeout(int value) = 0;
